...
public class BossLodick : MonoBehaviour
{
    ...
    public GameObject Enemy1, Enemy2, Prodektile;
    ...
    void Update() {
        ...
        if (canSpone && dis.magnitude - aldileDistToPlayer < 1) {
            GameObject obj = (Random.Range(0, 5) == 0 || curent == Fase.Fase1) ? (curent == Fase.Fase2 ? Enemy1 : Enemy2) : Prodektile;
            spone(obj, obj == (curent == Fase.Fase2 ? Enemy1 : Enemy2));
        }
